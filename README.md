...
- Dashboard：[C4142-BareMetal-Dashboard.user.js](./C4142-BareMetal-Dashboard.user.js)（固定安裝網址，腳本內版本 v1.11.4）
...
- URL：`https://azurecsi.visualstudio.com/Dev/_testPlans/charts?planId=3977295&suiteId=3977296`
...
1. 開啟固定入口的 [Dashboard JS](./C4142-BareMetal-Dashboard.user.js)。
